  ...
  return (
    <>
      ...
      <div className="relative">
        <div className="arrows2 absolute left-[12.5%] flex lg:left-[72.5%] lg:top-0 2xl:top-[400px]">
          {slide > 8 && (
            <Image
              width={50}
              height={50}
        ...
        <div className="arrows2 absolute right-[12%] flex lg:right-[7.5%] lg:top-0 2xl:top-[400px]">
          {slide < 11 && (
            <Image
              width={50}
              height={50}
